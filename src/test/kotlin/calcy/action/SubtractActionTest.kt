...
internal class SubtractActionTest {
    ...
    fun getIdentifier() {
        val subtractAction = SubtractAction(mockOperandStore, mockOperationHistory)
        assertEquals("-", subtractAction.getIdentifier())
    }
    ...
    fun executeInsufficientArguments() {
        ...
        assertThrows<InsufficientParametersException> { subtractAction.execute() }
    }
}
