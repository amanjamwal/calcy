...
internal class AddActionTest {
    ...
    fun getIdentifier() {
        val addAction = AddAction(mockOperandStore, mockOperationHistory)
        assertEquals("+", addAction.getIdentifier())
    }
    ...
    fun executeInsufficientArguments() {
        ...
        assertThrows<InsufficientParametersException> { addAction.execute() }
    }
}
