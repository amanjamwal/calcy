...
internal class DivideActionTest {
    ...
    fun getIdentifier() {
        val divideAction = DivideAction(mockOperandStore, mockOperationHistory)
        assertEquals("/", divideAction.getIdentifier())
    }
    ...
    fun executeInsufficientArguments() {
        ...
        assertThrows<InsufficientParametersException> { divideAction.execute() }
    }
}
